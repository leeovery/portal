...
**Resolution**: Pending
**Notes**: Partially dependent on resolution of finding 2 and 3.
...
**Resolution**: Pending
**Notes**: Minor since MarkerName centralizes this, but the spec should be definitive rather than suggestive.
