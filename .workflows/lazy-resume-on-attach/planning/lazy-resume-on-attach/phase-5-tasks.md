...
- `"it swallows a sequence whose final byte is an acting key"`
- `"it swallows a terminal background-colour reply whole"` (table: `\x1b]11;rgb:1d1d/1f1f/2121\x07`, the same reply terminated with `\x1b\`, per screen) (table: `\x1b[?1;2y` on the confirmation, `\x1b[5d` on the panel)
