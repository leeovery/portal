# Cross-Cutting State Display and Menu

*Reference for **[workflow-continue-cross-cutting](../SKILL.md)***

---

Display the selected cross-cutting concern's pipeline state, then collect the user's proceed-or-revisit choice. The caller provides `work_unit` — the concern's work unit name.
